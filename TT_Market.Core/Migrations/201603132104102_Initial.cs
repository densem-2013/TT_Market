    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Brand_Id, t.Country_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BrandCountries", "Country_Id", "dbo.Countries");
            DropForeignKey("dbo.BrandCountries", "Brand_Id", "dbo.Brands");
            DropIndex("dbo.BrandCountries", new[] { "Country_Id" });
            DropIndex("dbo.BrandCountries", new[] { "Brand_Id" });
